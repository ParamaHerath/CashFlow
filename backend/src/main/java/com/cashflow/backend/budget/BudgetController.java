...
public class BudgetController {
	...
	public List<BudgetResponse> list(@AuthenticationPrincipal UserPrincipal principal,
		...
		return budgetService.list(userId, month);
	}

	@PostMapping
	@ResponseStatus(HttpStatus.CREATED)
	public BudgetResponse create(@AuthenticationPrincipal UserPrincipal principal,
			@Valid @RequestBody BudgetRequest request) {
		UUID userId = requireUser(principal);
		return budgetService.create(userId, request);
	}
	...
	public BudgetResponse update(@AuthenticationPrincipal UserPrincipal principal,
		...
		UUID userId = requireUser(principal);
		return budgetService.update(userId, id, request);
	}
	...
	public ApiResponse delete(@AuthenticationPrincipal UserPrincipal principal,
		...
		return new ApiResponse("Budget deleted");
	}
